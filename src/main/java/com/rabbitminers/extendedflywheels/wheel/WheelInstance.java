...
public class WheelInstance extends KineticTileInstance<WheelTileEntity> implements DynamicInstance {

    protected final RotatingData shaft;
    protected final ModelData wheel;
    protected float lastAngle = Float.NaN;

    public WheelInstance(MaterialManager modelManager, WheelTileEntity tile) {
